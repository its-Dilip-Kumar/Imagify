                ...
                <div className="grid grid-cols-2 md:grid-cols-12 gap-6">
                    ...
                    <div className="col-span-2 md:col-span-4">
                        ...
                        <div className="flex items-center gap-3">
                            <a href="https://github.com/its-Dilip-Kumar" className="w-8 h-8 flex items-center justify-center rounded-full border border-gray-200 hover:border-gray-400 transition-colors">
                                <img src={assets.github_icon} alt="github" className="w-4 h-4" />
                            </a>
                            <a href="https://www.linkedin.com/in/dilip-kumar-j2002/" className="w-8 h-8 flex items-center justify-center rounded-full border border-gray-200 hover:border-gray-400 transition-colors">
